...
let htmlcode=`<div class="col-md-2">
    <div class="card">
        ...
        <div class="card-body text-center">
            ...
            <button class="btn btn-danger"id="dec-btn"><i class="bi bi-dash-circle-fill "></i></button>
            <span class="h2 "id="qty-ele">${product.qty}</span>
            <button class="btn btn-success"id="inc-btn"><i class="bi bi-plus-circle-fill "></i></button>
